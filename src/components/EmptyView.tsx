...
function EmptyView(props: { todos: Password[]; filter: Filter; onCreate: (title: string, password: string) => void }) {
  if (props.todos.length > 0) {
    return (
      <List.EmptyView
        icon="😕"
        title="No matching passwords found"
        description="Can't find a password matching your search. Create it now!"
        actions={
          <ActionPanel>
